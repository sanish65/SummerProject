            ...
            <div id="map">
                <div class="mapouter">
                    <div class="gmap_canvas">   
                         <iframe width="900px" height="569px" id="gmap_canvas" 
                        ...
                        frameborder="1" scrolling="no" marginheight="0" marginwidth="0">
                         ...
                         <style>.mapouter{position:relative;text-align:right;height:569px;width:900px;}.gmap_canvas {overflow:hidden;background:none!important;height:569px;width:900px;}</style>
                 </div> 
                </div></center>

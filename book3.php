            ...
            <div class="wow fadeInDown" data-wow-delay="0.3s">
                ...
                <div class="card">
                  <div class="card-body">
                        ...
                        <form method="POST" action="book13.php">
                            <p class="h5 text-center py-4"><font color="Green">Book now!!!  Table Charlie
							</font></p>
              ...
              <div class="md-form">
                        ...
                        //   </body></html>";
                            echo"<input type='hidden' name='user' value=$a>";
                            ?>

                            
                                        
                            <div class="text-center py-4 mt-3">
                                <button class="btn btn-cyan" type="submit">Book</button>
                            </div>
                        </form>

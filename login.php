    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent-7">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a class="nav-link" href="landing.html">About us
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12 white-text text-center">
                ...
                <p class="h4 text-center py-4"><font color="Green">Login now!</font></p>
    
                <!-- Material input text -->
                <div class="md-form">
                    <i class="fa fa-user prefix grey-text"></i>
                    <input type="text" id="materialFormCardNameEx" name="name1" class="form-control" required>
                ...
                <div class="md-form">
                    ...
                    <input type="password" id="materialFormCardPasswordEx"  name="pass1" class="form-control" required>
      ...
      <div class="row py-5 ">
        ...
        <div class="col-md-2 text-right">
                 ...
                 <ul class="nav nav-pills flex-column">
                   ...
                   <li class="nav-item">
                     <a class="nav-link" href="location1.php">Locate</a>
                   </li>
                   <!-- <li class="nav-item">
                     <a class="nav-link" href="notice2.php">Notice</a>
                   </li> -->
                   <li class="nav-item">
                      <a class="nav-link" href="review1.php">Tell us</a>
                    </li>
                 </ul>
                 <hr class="d-sm-none">

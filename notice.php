...
<div class="vl"></div> -->
         ...
         <p>Put the designated notice here.<br>Only Latest Notice will be uploaded in the User Dashboard</p>
      ...
      <input type="text" name="about" placeholder="About"><br>
       ...
       <div class="comment">
				<h2>Notice:</h2>
				<textarea rows="10" cols="50" placeholder="Notice here" name="notice"></textarea>
				<br>

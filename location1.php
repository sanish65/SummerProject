  ...
  <div class="container">
    ...
    <div class="row py-5 ">
      ...
      <ul class="nav nav-pills flex-column">
                   ...
                   <!-- <li class="nav-item">
                     <a class="nav-link" href="notice.php">Maintenance</a>
                   </li> -->
                   <li class="nav-item">
       ...
       <div class="col-md-10 text-center"><center>
                 <h3>Find us here:</h3>
            <div id="map">
                <div class="mapouter">
                    <div class="gmap_canvas">   
                         <iframe width="600" height="569" id="gmap_canvas" 
                        src="https://maps.google.com/maps?q=Capital%20Snooker%20%26%20Pool%20House&t=&z=13&ie=UTF8&iwloc=&output=embed" 
                        frameborder="1" scrolling="no" marginheight="0" marginwidth="0">
                            </iframe>
                      </div>
                         <style>.mapouter{position:relative;text-align:right;height:569px;width:600px;}.gmap_canvas {overflow:hidden;background:none!important;height:569px;width:600px;}</style>
                 </div> 
                </div></center>

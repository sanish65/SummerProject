                              ...
                              <div class="collapse navbar-collapse" id="navbarSupportedContent-7">
                                <ul class="navbar-nav mr-auto">
                                  <li class="nav-item active">
                                    <a class="nav-link" href="adminindex.html">Home
                                      <span class="sr-only">(current)</span>
                                    </a>
                                  </li>
                                  <li class="nav-item">
                                    <a class="nav-link" href="admintables.php">Manage tables</a>
                                  </li>
                                  <li class="nav-item">
                                  ...
                                  <div class="col-md-12 white-text text-center">
                                    ...
                                    <div class="wow fadeInDown" data-wow-delay="0.3s">
                                      <!-- <a class="btn btn-light-blue btn-lg" href="register.html"><span id="register_me" onclick="register_me()">Register Me</span></a>
                                        ...
                                        <a class='btn btn-indigo btn-lg disabled' href='book1.php' >Book Now</a> -->
...
<!--                                         
                                 ...
                                 <div class="col-md-10 text-center">
                                   <p class="justify-content-justify">
                                     <h3>Manage your tables from here.</h3>
                                     <center>
 ...
 $result=mysqli_query($con,$sql) or die(mysqli_error($con));
   if(mysqli_num_rows($result)>0)
     ...
     echo"<tr><th class='black white-text' scope='col' colspan=5>Book No.</th><th class='black white-text' scope='col' colspan=5>Booked By:</th><th class='black white-text' scope='col' colspan=20>Date</th><th class='black white-text' scope='col' colspan=10>Start Time</th><th  class='black white-text' scope='col' colspan=10>End Time</h><th  class='black white-text' colspan=15>Alter</tr>";
   while($row=mysqli_fetch_assoc($result))
     {
      $a=$row["r_id"];
      echo"<tr><td colspan=5>".$row['r_id']."</td><td colspan=5>
      ".$row['user'].
      "</td><td colspan=20>
      ".$row['reg_date']."</td><td colspan=10>".$row['time1']."</td><td colspan=10>".$row['time2']."</td><td colspan=15><table><tr><td><form method='POST' action='bookingdelete.php'>
      <input type='hidden' name='a' value=$a  >
      <input type='submit' value='delete'class='button'></form></td><td><form method='POST' action='update.php'>
      <input type='hidden' name='a' value=$a >
      <input type='submit' value='update' class='button'></form></td></tr></table></td></tr>";
   ...
   while($row=mysqli_fetch_assoc($result))
     {
      ...
      ".$row['user'].
      "</td><td colspan=20>
      ".$row['reg_date']."</td><td colspan=10>".$row['time1']."</td><td colspan=10>".$row['time2']."</td><td colspan=15><table><tr><td><form method='POST' action='bookingdelete2.php'>
      <input type='hidden' name='a' value=$a  >
      <input type='submit' value='delete'class='button'></form></td><td><form method='POST' action='update2.php'>
      <input type='hidden' name='a' value=$a >
      <input type='submit' value='update' class='button'></form></td></tr></table></td></tr>";
   ...
   while($row=mysqli_fetch_assoc($result))
     {
       ...
       ".$row['user'].
       "</td><td colspan=20>
       ".$row['reg_date']."</td><td colspan=10>".$row['time1']."</td><td colspan=10>".$row['time2']."</td><td colspan=15><table><tr><td><form method='POST' action='bookingdelete3.php'>
       <input type='hidden' name='a' value=$a  >
       <input type='submit' value='delete'class='button'></form></td><td><form method='POST' action='update3.php'>
       <input type='hidden' name='a' value=$a >
       <input type='submit' value='update' class='button'></form></td></tr></table></td></tr>";
